        ...
        VStack {
            ...
            ZStack(alignment: .topLeading) {
                ...
                ZStack(alignment: .top) {
                    ...
                    ScrollViewLearningObjectives(totalLOs: totalLOs, learningPathSelected: Binding.constant(nil), filterChallenge: selectedFilter, isAddable: true, textFromSearchBar: searchText, selectedStrands: selectedStrands).padding(.top, 50).padding(.bottom, 50)
                }
