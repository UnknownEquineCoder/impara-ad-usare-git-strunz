    ...
    var body: some Scene {
        WindowGroup {
            StartView(isLoading: $isLoading)
                ...
                .frame(minWidth: NSScreen.screenWidth! * 0.9, maxWidth: NSScreen.screenWidth!, minHeight: NSScreen.screenHeight! * 0.8, maxHeight: NSScreen.screenHeight!, alignment: .center)
                .fileExporter(
